...
class SubstitutionTemplateMappingBase(TemplateModelMixin):
    ...
    def interface_template(cls):
        """
        Interface template to expose (can be ``None``).

        :type: :class:`InterfaceTemplate`
        """
        return relationship.one_to_one(
            cls, 'interface_template', back_populates=relationship.NO_BACK_POP)
    ...
    def interface_template_fk(cls):
        """For SubstitutionTemplate one-to-one to InterfaceTemplate"""
