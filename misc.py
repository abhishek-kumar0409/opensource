...
from .modeling.substitution_mappings import (validate_substitution_mappings_requirement,
                                             ...
                                             validate_substitution_mappings_interface,
                                             validate_substitution_mappings_property,
                                             validate_substitution_mappings_attribute)
...
class SubstitutionMappingsInterface(AsIsPresentation):
    """
    Substitution mapping for interfaces.
    """
    ...
    def _validate(self, context):
        super(SubstitutionMappingsInterface, self)._validate(context)
        validate_substitution_mappings_interface(context, self)

class SubstitutionMappingsProperty(AsIsPresentation):
    """
    Substitution mapping for interfaces.
    """
    ...
    def _validate(self, context):
        super(SubstitutionMappingsProperty, self)._validate(context)
        validate_substitution_mappings_property(context, self)

class SubstitutionMappingsAttribute(AsIsPresentation):
    """
    Substitution mapping for attributes.
    """
    ...
    def _validate(self, context):
        super(SubstitutionMappingsAttribute, self)._validate(context)
        validate_substitution_mappings_attribute(context, self)
